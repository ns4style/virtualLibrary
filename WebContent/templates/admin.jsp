...
;
		...
		<div class="wrap">
			...
			<div class="middle text-center">
				<div>
					...
					<a data-target="#genres" data-toggle="modal" href="" class="btn">Edit
						genres</a>
				</div>
				<div>
					<h3>Edit list of tags</h3>
					<a data-target="#tags" data-toggle="modal" href="" class="btn">Edit
						tags</a>

				</div>
				<div>
					<h3>Edit list of Authors</h3>
					<a data-target="#authorsModal" data-toggle="modal" href=""
						class="btn">Edit Authors</a>

				</div>
				<div>
					<h3>Edit list of News</h3>
					<a data-target="#news" data-toggle="modal" href="" class="btn">Edit
						News</a>

				</div>
				<div>
					<h3>Edit list of Books</h3>
					<a data-target="#books" data-toggle="modal" href="" class="btn">Edit
						Books</a>
				...
				<div>
					...
					<a data-target="#users" data-toggle="modal" href="" class="btn">Edit
						Users</a>
				</div>
			</div>
	...
	<div>
		<div id="bookEditDetail" class="modal hide fade text-center">
			<div class="modal-header" id="bookEditDetail-header"></div>
			<div id="bookEditDetail-body"
				class="modal-body pull-left text-left span5"></div>
		</div>
	</div>
	...
	<div>
		<div id="userEditDetail" class="modal hide fade text-center">
			<div class="modal-header" id="userEditDetail-header"></div>
			<div id="userEditDetail-body"
				class="modal-body pull-right text-left span3"></div>
		</div>
	</div>
	<div>
		<div id="userbooksDetail" class="modal hide fade text-center">
			<div class="modal-header" id="userbooksDetail-header"></div>
			<div id="userbooksDetail-body" class="modal-body text-left"></div>
		</div>
	</div>
